...
<p align="center">
  ...
  <br><sub>メイン画面 — Final Cutのプロジェクトを<b>ウインドウのどこにでも</b>ドロップし、右側で音声認識・字幕・出力オプションを選んで<b>分析開始</b>。あまり使わないオプションは<b>詳細設定</b>に折りたたまれています。</sub>
</p>
...
<p align="center">
  ...
  <br><sub>文字起こしエディタ — 左に<b>文字起こし</b>、中央に<b>映像ビューア</b>（字幕をリアルタイム表示）、右に<b>AIエージェント・字幕/出力</b>タブ、下に<b>波形</b>がひとつの画面に。</sub>
</p>
...
文字起こしエディタ右側の<b>AI整理</b>タブにいるAIに、編集を任せられます。**要約や抜粋では文字起こしテキスト自体は変えず、必要な区間だけをカット**します（句読点の挿入など、テキストを編集する機能もあります）。結果はいつでも確認・元に戻せます。
...
2. ダブルクリックして起動 — **Appleの公証（notarization）済みのため、セキュリティ警告なしで開きます。**
   （警告が出る場合は古いバージョンが残っています: `xattr -cr "/Applications/TypeCut Pro.app"`）
